...
//
//        // Rejestrujemy RightClickCanceller (tick) żeby zmniejszał cancelTimer
//        RightClickCanceller.register();
//
//        // Event listeners
//        registerTickEvents();
//
...
//
//            // wykrywamy krawędź wciśnięcia PPM i wywołujemy handler
//            if (isRightPressed && !wasRightPressed) {
//                // Wywołanie głównego handlera który robi raycast i wysyła pakiet do serwera
